...
class FriendAdapter(private val dataSet: List<String>, private val parentActivity: FragmentActivity?) : RecyclerView.Adapter<FriendAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val friend: User = UserRepo.findUserById(dataSet[position])
