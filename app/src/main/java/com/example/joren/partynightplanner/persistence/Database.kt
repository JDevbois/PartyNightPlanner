...
import com.example.joren.partynightplanner.persistence.notifications.NotificationDao
...
class Database private constructor(){
    ...
    val notificationDao: NotificationDao = NotificationDao()
    ...
    companion object {
        ...
        val notificationCloudEndPoint: DatabaseReference = firebaseReference.child("notifications")
